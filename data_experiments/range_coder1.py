...
Найс, значит всё работает, только теперь надо ка-то научиться комрессовать это ещё в смайлики что ли и будет чух А то что это такое почему так плохо получается - меня хафман почти обогнал. я 
